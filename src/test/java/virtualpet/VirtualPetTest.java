...
public class VirtualPetTest {
	...
	@Test
	public void feedPetCheckNewValues() {
		VirtualPet mypet = new VirtualPet();
		mypet.feed();
	...
	@Test
	public void waterPetCheckNewValues() {
	...
	@Test
	public void walkPetCheckNewValues() {
		VirtualPet mypet = new VirtualPet();
		mypet.walk();
	...
	@Test
	public void sleepPetCheckNewValues() {
		VirtualPet mypet = new VirtualPet();
		mypet.sleep();
	...
	@Test
	public void playPetCheckNewValues() {
		VirtualPet mypet = new VirtualPet();
		mypet.play();
		Assert.assertEquals(25, mypet.getHunger());
		Assert.assertEquals(30, mypet.getThirst());
